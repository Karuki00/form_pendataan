...
return [
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'id.pakwardoyo.pendataanpenduduk'),
     ...
     */
    'author' => env('NATIVEPHP_APP_AUTHOR', 'Pak Wardoyo'),

    /**
     * The copyright notice for your application.
     */
    'copyright' => env('NATIVEPHP_APP_COPYRIGHT', 'Copyright © 2026 Pak Wardoyo'),

    /**
     * The description of your application.
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'Desktop application for managing population data'),
     ...
     */
    'prebuild' => [
        // NativePHP 2.3.0 may omit this generated plugin file from its package.
        'npm --prefix vendor/nativephp/desktop/resources/electron run plugin:build',
    ],
